www\documentclass[12pt, oneside, openany]{book}
...
\addcontentsline{toc}{subsubsection}{Technically correct: weather data frames completet}
...
\subsubsection*{VAT}
\addcontentsline{toc}{subsubsection}{VAT}
